          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-2">
              <a
                ...
                className="p-2 text-white/40 hover:text-white transition-colors duration-200 rounded-lg hover:bg-white/5"
                aria-label="GitHub"
              >
                <GitHubIcon />
              </a>
            ...
            <motion.a
              ...
              className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-white rounded-lg bg-gradient-to-r from-violet-600 to-blue-600 hover:from-violet-500 hover:to-blue-500 transition-all duration-200 shadow-[0_0_20px_rgba(109,40,217,0.3)] hover:shadow-[0_0_30px_rgba(109,40,217,0.5)]"
            ...
            >
              ...
              />
              <span
                className={`block h-px w-4 bg-white/60 transition-all duration-300 group-hover:w-6 ${
                  menuOpen ? "opacity-0" : ""
                }`}
              />
              <span
